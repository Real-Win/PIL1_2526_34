...
# Dictionnaire global pour stocker les tokens (en mémoire)
reset_tokens = {}
...
# ======================= RÉINITIALISATION MOT DE PASSE (SANS EMAIL) =======================
    ...
    if request.method == "POST":
        ...
        if not mot_de_passe or len(mot_de_passe) < 6:
            ...
            try:
                ...
                flash("Une erreur interne s'est produite. Veuillez réessayer.", "danger")

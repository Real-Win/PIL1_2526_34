...
def envoyer_email_smtp(destinataire, sujet, contenu_html):
    ...
    try:
        # Paramètres SMTP (ceux que tu as dans Brevo)
        smtp_server = "smtp-relay.brevo.com"
        smtp_port = 587
        smtp_user = "ae3c1a001@smtp-brevo.com"  # Ta connexion
        smtp_password = "hgWEKV0O6j8Yp2ZC"       # Ton mot de passe
        
        # Création du message
        msg = MIMEMultipart()
        msg["From"] = "mentorlink@ifri-uac.bj"
        msg["To"] = destinataire
        msg["Subject"] = sujet
...
def demander_reinitialisation(email):
    try:
        ...
        site_url = os.environ.get("SITE_URL", "https://ton-site-render.onrender.com")
        ...
        <body style="font-family: Arial, sans-serif;">
            <div style="max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f8fafc;">
                ...
                <div style="background-color: white; padding: 30px; border-radius: 0 0 10px 10px;">
                    ...
                    <a href="{lien_reset}" style="color: #2563eb; word-break: break-all;">{lien_reset}</a></p>
